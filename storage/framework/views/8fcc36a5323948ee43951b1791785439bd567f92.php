                        ...
                        <form action="admin/slide/sua/<?php echo e($slide->id); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                value="<?php echo e($slide->link); ?>" />
                            </div>
                            <div class="form-grounp">
                                 <label>Hình ảnh</label>
                                 <p><img width="500px" src="upload/slide/<?php echo e($slide->Hinh); ?>" alt=""></p>
...
<?php echo $__env->make('admin.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DACN\LaravelDemo\resources\views/admin/slide/sua.blade.php ENDPATH**/ ?>