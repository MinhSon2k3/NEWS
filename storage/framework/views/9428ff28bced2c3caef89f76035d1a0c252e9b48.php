            ...
            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                ...
                <tbody>
                    ...
                    <tr class="odd gradeX" align="center">
                        ...
                        <td>
                            <img width="400px" src="upload/slide/<?php echo e($sd->Hinh); ?>">
                        </td>
...
<?php echo $__env->make('admin.layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DACN\LaravelDemo\resources\views/admin/slide/danhsach.blade.php ENDPATH**/ ?>