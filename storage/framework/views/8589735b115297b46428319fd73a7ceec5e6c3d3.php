            ...
            <div class="col-lg-9">
               ...
               <?php if(Auth::check()): ?>
                <div class="well">
                    ...
                    <form action="comment/<?php echo e($tintuc->id); ?>" role="form" method="post">
...
<?php echo $__env->make('layout.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\DACN\LaravelDemo\resources\views/pages/tintuc.blade.php ENDPATH**/ ?>